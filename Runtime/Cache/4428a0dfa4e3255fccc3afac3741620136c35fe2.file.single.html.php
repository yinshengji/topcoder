<?php /* Smarty version Smarty-3.1.6, created on 2017-05-17 15:26:09
         compiled from "/var/www/html/Topcoder/Home/View/Project/single.html" */ ?>
<?php /*%%SmartyHeaderCode:1274429679591bfb117acb08-48930448%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4428a0dfa4e3255fccc3afac3741620136c35fe2' => 
    array (
      0 => '/var/www/html/Topcoder/Home/View/Project/single.html',
      1 => 1482149822,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1274429679591bfb117acb08-48930448',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_591bfb117ea11',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_591bfb117ea11')) {function content_591bfb117ea11($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
<title>项目组</title>
	...
	<div class="container">
		<div class="projects-main">
			  <div class="projects-top">
			  	<h3>TopCoder项目组</h3>
			  	<p style="letter-spacing:1px;">TopCoder项目组成立于2010年，主要从事学习网站方面的相关设计与开发，主要学习HTML，CSS，Photoshop，JavaScipt，PHP，MySQL等。通过做项目来提升自己的实践能力和团队协作能力，积累经验，为以后自己的创业或就业提供丰富的实践锻炼。作为创新型团队，我们本着勇于创新，追求卓越的目标，学长学姐们提供耐心认真的指导，团队成员之间的分享，使个人及团队的学习效率更高，离自己的梦想更进一步！</p>
			  </div>
			   ...
			   <div class="p-single">
			    	<div class="col-md-2 p-single-left">
			    		...
			    		<div class="details">
			    				<p>名称：<span class="detail-col">和美装饰设计</span></p>
			    				<p>作者：<span class="detail-col">TopCoder项目组</span></p>
			    			</div>
			    	</div>
...
/li-ar.png);margin-top:20px;letter-spacing:1px;" class="main">
			  			...
			  			<li>网站的制作离不开团队合作，队员之间应该团结互助，相互分享。</li>
			  		</ul>
			  	 </div>
			  	 <div class="clearfix"> </div>
			    </div>
			  ...
			  <br />
			  	<div class="col-md-2 p-single-left">
			  		...
			  		<div class="details">
			  				<p>名称：<span class="detail-col">白河商城</span></p>
			  				<p>作者：<span class="detail-col">TopCoder项目组</span></p>
			  			</div>
			  	</div>
			  <div class="col-md-10 single-inform wow bounceInRight" data-wow-delay="0.4s">
...
/li-ar.png);margin-top:20px;letter-spacing:1px;" class="main">
			  			...
			  			<li>爱因斯坦曾说：什么是成功的秘诀？“A=X+Y+Z”，“A代表成功，X代表艰苦劳动，Y代表正确方法，Z代表少说废话”</li>
			  		</ul>
				 </div>
				 <div class="clearfix"> </div>
			  </div>
			 ...
			 <div class="p-single">
			  	<div class="col-md-2 p-single-left">
			  		...
			  		<div class="details">
			  				<p>名称：<span class="detail-col">Xworld校园服务平台</span></p>
			  				<p>作者：<span class="detail-col">TopCoder项目组</span></p>
			  			</div>
			  	</div>
			  <div class="col-md-10 single-inform wow bounceInRight" data-wow-delay="0.4s">
...
/li-ar.png);margin-top:20px;letter-spacing:1px;" class="main">
			 ...
			 <div class="p-single">
			   	<div class="col-md-2 p-single-left">
			   		...
			   		<div class="details">
			   				<p>名称：<span class="detail-col">汇腾环保设备有限责任公司</span></p>
			   				<p>作者：<span class="detail-col">TopCoder项目组</span></p>
			   			</div>
			   	</div>
			   <div class="col-md-10 single-inform wow bounceInRight" data-wow-delay="0.4s">
...
/li-ar.png);margin-top:20px;letter-spacing:1px;" class="main">
			  			...
			  			<li>主体：展示想要表达的东西。</li>
			  			<li>幸运之神的降临，往往只是因为你多看了一眼，多想了一下，多走了一步。</li>
			  		</ul>
			 	 </div>
			 	 <div class="clearfix"> </div>
			   </div>
...
/li-ar.png);">
				 		    		...
				 		    		<li><a href="http://www.missyuan.com/forum-18-1.html" target="_blank">PS平面设计</a></li>
				 		    	</ul>
				 		    </div>
				 		</div>
