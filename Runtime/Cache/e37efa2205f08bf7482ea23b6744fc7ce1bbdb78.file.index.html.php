<?php /* Smarty version Smarty-3.1.6, created on 2017-05-17 14:47:36
         compiled from "/var/www/html/Topcoder/Home/View/Index/index.html" */ ?>
<?php /*%%SmartyHeaderCode:354247537591bf208cadf81-08266406%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e37efa2205f08bf7482ea23b6744fc7ce1bbdb78' => 
    array (
      0 => '/var/www/html/Topcoder/Home/View/Index/index.html',
      1 => 1482210242,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '354247537591bf208cadf81-08266406',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_591bf208cec18',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_591bf208cec18')) {function content_591bf208cec18($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
<title>首页</title>
...
/c1.jpg" alt=""/>
					<p>文章分类：PQJ、 NYOJ、 数据结构、 字符串处理、动态规划、&nbsp; 乱七八糟 、贪心、 搜索、 数论、&nbsp; 矩阵、&nbsp; 图论、 Game、 ACMer、 树状数组、 线段数、</p>
			...
			<div class="col-md-4 info-grids-cr wow bounceIn" data-wow-delay="0.4s">
				...
				<div class="info-bott">
					<img src="<?php echo @images;?>
/c2.jpg" alt=""/>
				    <p>文章分类：点点滴滴、学习笔记、比赛总结、动态规划、计算几何、字符串、模拟、贪心、搜索、&nbsp;博弈、Template、图论、OfferKiller、&nbsp;&nbsp;数学、数据结构</p>
